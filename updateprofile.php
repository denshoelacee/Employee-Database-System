    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link btn btn-danger text-blue" href="login-form.php">
    ...
    <div class="container-fluid">
        ...
        <div class="container p-4" style="box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;">
            ...
            <form method="POST" action="updateprofile.php">
                ...
                <center><button type="submit" name="fetchProfile" class="btn btn-primary">Fetch Profile</button></center>
            </form>
            ...
            if (isset($_POST['fetchProfile'])) {
                ...
                if ($result->num_rows > 0) {
                    ...
                    <form method="POST" action="updateprofile.php">
                        ...
                        <center><button type="submit" name="updateprofile" class="btn btn-success">Update Profile</button></center>
                    </form>
                    <?php
                } else {
            ...
            if (isset($_POST['updateprofile'])) {
                ...
                $sql = "UPDATE employees SET firstname=?, middlename=?, lastname=?, barangay=?, municipality=?, job=? WHERE empID=?";
                $stmt = $con->prepare($sql);
                $stmt->bind_param("ssssssi", $firstname, $middlename, $lastname, $barangay, $municipality, $job, $empID);
                if ($stmt->execute()) {
